            ...
            <div className="pagecontent">
                ...
                <form>
                    ...
                    <div className="caption">
                        ...
                        in 6th grade when I was following in my father's footsteps. I hold 2
                    ...
                    <div className="caption">
                        ...
                        very gratifying. Our team was one of the top five donors for the Greater
                        Cincinnati Polar Plunge in February 2018 and helped to raise over $6,000.
                    </div>
                    <img className="activityImage" src={habitat}></img>
                    <div className="caption">
                        <b>Habitat For Humanity </b>- Through Phi Sigma Kappa I have had the priviledge work on two separate habitat for humanity projects. It is always
