            ...
            <div className="pagecontent">
                ...
                <form>
                    ...
                    <div className="caption">
                        ...
                        Engineering and Data Science. This has been an
                        enjoyable hybrid role and allowed me to gain valuable experience about cloud
                        computing and SQL Server Integration Services.
                    </div>
                    <img className="activityImage" src={siemens}></img>
                    <div className="caption">
                        <b>Siemens PLM </b>- Over the course of three semesters as a Software
                        Engineering CO-OP student I learned about client-server architecture, web
                    ...
                    <div className="caption">
                        These are just some of the technologies I have worked with professionally.
                    </div>
